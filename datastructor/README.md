 ...
 * @Description:
 * @author: 贾森
 * @date: 2024年05月07日 下午11:05
 */
public class CountungSort {
    public static void main(String[] args) {
        int[] data = {47, 71, 96, 94, 10, 74, 44, 49, 85, 36, 53, 56, 47, 25, 27, 46, 45, 47, 76, 48, 85, 82,
                4, 79, 66, 64, 38, 9, 31, 90, 18, 72, 88, 85, 44, 30, 49, 93, 58, 82, 13, 24, 46, 94,
                68, 82, 14, 28, 43, 81, 46, 27, 42, 44, 23, 62, 88, 51, 43, 98, 24, 65, 45, 60, 80, 29,
                15, 33, 24, 28, 28, 22, 13, 67, 41, 13, 66, 66, 75, 16, 80, 68, 10, 20, 25, 28, 2, 85,
                32, 32, 46, 27, 88, 51, 40, 51, 39, 82, 47, 24, 68, 42, 1, 97, 50, 67, 77, 52, 100, 5,
                ...
                63, 9, 35, 70, 88, 91, 98, 30, 9, 38, 53, 91, 19, 27, 100, 51, 7, 47, 92, 35, 54, 35,
                70, 52, 3, 68, 51, 41, 18, 55, 27, 41, 98, 50, 97, 59};
        CountungSort.countingSort(data, 100);
        for (int i = 0; i < data.length; i++) {
            System.out.print(data[i] + "  ");
        }
    ...
    public static  void countingSort(int[] arr,int max){
        ...
        int i = 0;
        for (int m = 0 ;m  < occurences.length-1;m++){
            for (int j=1;j<=occurences[m];j++){
                arr[i] = m;
                i++;
            }
        }
...
func main() {
	arr := []int{47, 71, 96, 94, 10, 74, 44, 49, 85, 36, 53, 56, 47, 25, 27, 46, 45, 47, 76, 48, 85, 82,
		4, 79, 66, 64, 38, 9, 31, 90, 18, 72, 88, 85, 44, 30, 49, 93, 58, 82, 13, 24, 46, 94,
		68, 82, 14, 28, 43, 81, 46, 27, 42, 44, 23, 62, 88, 51, 43, 98, 24, 65, 45, 60, 80, 29,
		15, 33, 24, 28, 28, 22, 13, 67, 41, 13, 66, 66, 75, 16, 80, 68, 10, 20, 25, 28, 2, 85,
		32, 32, 46, 27, 88, 51, 40, 51, 39, 82, 47, 24, 68, 42, 1, 97, 50, 67, 77, 52, 100, 5,
...
func countingSort(arr []int, max int) {
	occurences := make([]int, max+1)
	for i := 0; i < len(arr); i++ {
		occurences[arr[i]] += 1
	}

	j := 0
	for m := 0; m < len(occurences); m++ {
		for n := 1; n <= occurences[m]; n++ {
			arr[j] = m
			j++
		}
	}
...
def counting_sort(arr):
    max_num = max(arr)
    occurences = [0]*(max_num+1)

    for num in arr:
        occurences[num] += 1
    j = 0
    for m in range(len(occurences)):
        for n in range(occurences[m]):
            arr[j] = m
            j += 1


arr = [47, 71, 96, 94, 10, 74, 44, 49, 85, 36, 53, 56, 47, 25, 27, 46, 45, 47, 76, 48, 85, 82,4, 79, 66, 64, 38, 9, 31,
           90, 18, 72, 88, 85, 44, 30, 49, 93, 58, 82, 13, 24, 46, 94,68, 82, 14, 28, 43, 81, 46, 27, 42, 44, 23, 62, 88, 51,
           43, 98, 24, 65, 45, 60, 80, 29,15, 33, 24, 28, 28, 22, 13, 67, 41, 13, 66, 66, 75, 16, 80, 68, 10, 20, 25, 28, 2,
           85,32, 32, 46, 27, 88, 51, 40, 51, 39, 82, 47, 24, 68, 42, 1, 97, 50, 67, 77, 52, 100, 5,
           45, 25, 57, 72, 73, 99, 91, 86, 76, 90, 33, 48, 89, 77, 50, 81, 98, 54, 56, 52, 97, 71,
           25, 80, 2, 10, 34, 57, 90, 73, 51, 54, 46, 7, 29, 76, 36, 18, 72, 76, 73, 69, 57, 22,
           99, 59, 67, 38, 5, 25, 63, 61, 9, 39, 95, 16, 22, 25, 32, 18, 23, 39, 81, 80, 100, 70,
           63, 9, 35, 70, 88, 91, 98, 30, 9, 38, 53, 91, 19, 27, 100, 51, 7, 47, 92, 35, 54, 35,
...
function countingSort(arr, max) {
  var occurences = new Array(max + 1);
  for (var i = 0; i < arr.length; i++) {
    if (!occurences[arr[i]]) {
      occurences[arr[i]] = 0;
    }
  ...
  var j = 0;
  for (var m = 0; m < occurences.length; m++) {
    for (var n = 1; n <= occurences[m]; n++) {
      arr[j] = m;
      j++;
    }
  }
...
var arr5 = [
  47, 71, 96, 94, 10, 74, 44, 49, 85, 36, 53, 56, 47, 25, 27, 46, 45, 47, 76,
  48, 85, 82, 4, 79, 66, 64, 38, 9, 31, 90, 18, 72, 88, 85, 44, 30, 49, 93, 58,
  82, 13, 24, 46, 94, 68, 82, 14, 28, 43, 81, 46, 27, 42, 44, 23, 62, 88, 51,
  43, 98, 24, 65, 45, 60, 80, 29, 15, 33, 24, 28, 28, 22, 13, 67, 41, 13, 66,
  66, 75, 16, 80, 68, 10, 20, 25, 28, 2, 85, 32, 32, 46, 27, 88, 51, 40, 51, 39,
  82, 47, 24, 68, 42, 1, 97, 50, 67, 77, 52, 100, 5, 45, 25, 57, 72, 73, 99, 91,
  86, 76, 90, 33, 48, 89, 77, 50, 81, 98, 54, 56, 52, 97, 71, 25, 80, 2, 10, 34,
  57, 90, 73, 51, 54, 46, 7, 29, 76, 36, 18, 72, 76, 73, 69, 57, 22, 99, 59, 67,
  38, 5, 25, 63, 61, 9, 39, 95, 16, 22, 25, 32, 18, 23, 39, 81, 80, 100, 70, 63,
  9, 35, 70, 88, 91, 98, 30, 9, 38, 53, 91, 19, 27, 100, 51, 7, 47, 92, 35, 54,
  35, 70, 52, 3, 68, 51, 41, 18, 55, 27, 41, 98, 50, 97, 59,
];
console.log("排序前的数组:", arr5);
countingSort(arr5, 100);
console.log("排序后的数组:", arr5);
...
```typescript
function countingSort(arr: number[], max: number) {
  let occurences: number[] = new Array(max + 1);
  ...
  let j = 0;
  for (let m = 0; m < occurences.length; m++) {
    for (let n = 1; n <= occurences[m]; n++) {
      arr[j] = m;
      j++;
    }
  }
...
public class BucketSort {
    public static void main(String[] args) {
        int[] data = {47, 71, 96, 94, 10, 74, 44, 49, 85, 36, 53, 56, 47, 25, 27, 46, 45, 47, 76, 48, 85, 82,
                ...
                63, 9, 35, 70, 88, 91, 98, 30, 9, 38, 53, 91, 19, 27, 100, 51, 7, 47, 92, 35, 54, 35,
                70, 52, 3, 68, 51, 41, 18, 55, 27, 41, 98, 50, 97, 59};
        BucketSort.bucketSort(data, 100);
        for (int i = 0; i < data.length; i++) {
            System.out.print(data[i] + "  ");
        }
    ...
    public static void bucketSort(int[] arr,int max){
        ...
        for (int x : arr){
            if (buckets[len * x / max]==null){
                buckets[len * x / max] = new int[]{x};
            } else {
               // buckets[len * x / max][buckets[len * x / max].length] = x;
                int[] temp = buckets[len * x / max];
...
func bucketSort(arr []int, max int) {
	lenth := len(arr)
	buckets := make([][]int, lenth+1)
	for i := 0; i < lenth; i++ {
		temp := make([]int, len(buckets[lenth*arr[i]/max])+1)
		for y := 0; y < len(buckets[lenth*arr[i]/max]); y++ {
			temp[y] = buckets[lenth*arr[i]/max][y]
		}
		temp[len(buckets[lenth*arr[i]/max])] = arr[i]
		buckets[lenth*arr[i]/max] = temp

	}
	for j := 0; j < len(buckets); j++ {
		insert_sorting(buckets[j])
	}
	m := 0
	for n := 0; n < len(buckets); n++ {
		for k := 0; k < len(buckets[n]); k++ {
			arr[m] = buckets[n][k]
			m++
		}
	}
}
func insert_sorting(arr []int) {
	n := len(arr)
	for i := 1; i < n; i++ {
		for j := i; j > 0; j-- {
			if arr[j] < arr[j-1] {
